...
/**
 * Created by yfyandr on 2017/11/14.
 */

public class PickerView extends View {

    public static final String TAG = "zxx";
    /**
...
//        mCurrentSelected = datas.size() / 2;
    ...
    public void setSelected(int selected) {
        Integer size=mDataList.size();
        mCurrentSelected = selected;
//        switch (selected){
//            case 0:
//                mCurrentSelected = selected+1;
//
//                break;
//            case 12:
...
//
        ...
        Log.e(TAG, "drawOtherText: "+(mCurrentSelected + type * position) );
    }
