...
import com.zxx.tools.ZxTextWatcher;
...
public class ClearableEditText extends EditText {
    ...
    public void init(Context context) {
        rigthDrawable = context.getResources().getDrawable(R.drawable.banner_point_checked_false);
        mCallback = null;
        //重写了TextWatcher，在具体实现时就不用每个方法都实现，减少代码量
        TextWatcher textWatcher = new ZxTextWatcher() {
            @Override
