...
/**
 * Created by yfy1 on 2016/8/27.
 */
public class ListItemSliding extends ListView {
    ...
    public ListItemSliding(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public ListItemSliding(Context context, AttributeSet attrs, int defStyle) {
